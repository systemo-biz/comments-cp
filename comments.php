...
if ( post_password_required() )
	return;
?>
<div id="comments_wrapper_cp">
    <h1>Комментирование</h1>
    <div id="comment_form_cp" class="comments-area">

	<?php 

	$args = array(
		'comment_field' => '<p class="comment-form-comment"><textarea class="form-control" id="comment" name="comment" cols="35" rows="6" aria-required="true"></textarea></p>',
		'fields'        => array(
...
<?php if ( have_comments() ) : ?>
	<div id="comments" class="comments-area">
		...
		<?php endif; // check for comment navigation ?>
            ...
            <ul class="comment-list-cp list-group">
            <?php
                ...
                wp_list_comments( 
                    array( 
                        //'callback' => 'comment_cp', //временно отключил, но можно включить и заточнить функцию на лучший вывод
                        //'walker' => new Walker_Comment_CP() //временно отключил, но можно расскомментировать и заточить под нужные требования
                    ) );
            ?>
            </ul><!-- .comment-list -->
